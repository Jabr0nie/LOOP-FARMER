...
address tokenX = 0x78c1b0C915c4FAA5FffA6CAbf0219DA63d7f4cb8; //WMNT - make var
address tokenY = 0xdEAddEaDdeadDEadDEADDEAddEADDEAddead1111; //WETH - make var
address LBPool = 0x1606C79bE3EBD70D8d40bAc6287e23005CfBefA2; 
address LBrouter = 0x013e138EF6008ae5FDFDE29700e3f2Bc61d21E3a;
address MoeRewarder = 0x187C41cC09020Bf9d8d0aec22B5BD063B74c4C85;//unique per pool - make variable
address Moe = 0x4515A45337F461A11Ff0FE8aBF3c606AE5dC00c9; 
address router = 0xeaEE7EE68874218c3558b40063c42B82D3E7232a;
uint256 binsAmount;
uint256 BinHolder;
uint256 binStep = 10;
uint16 removebinStep = 10;
