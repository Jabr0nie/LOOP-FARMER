...
address USDC = 0x09bc4e0d864854c6afb6eb9a9cdf58ac190d0df9; //tokenX
...
address MoeRewarder = 0x08A62Eb0ef6DbE762774ABF5e18F49671559285b;//Only rewarder for the USDC/USDT 1 Pool
...
//Swap directly with MM
  function rebalance() external payable {
       ...
       IERC20[] memory tokenPath = new IERC20[](2);
        ...
        uint128 amountOut = 0;
        IERC20(USDC).approve(LBrouter, amountIn);
  ...
  function compoundMoe() external payable {
       ...
       IERC20[] memory tokenPath = new IERC20[](2);
            ...
            tokenPath[0] = IERC20(Moe);
            tokenPath[1] = IERC20(USDT);


        uint128 amountOut = 0;
        IERC20(Moe).approve(LBrouter, amountIn);
...
function AddLiquidity() external payable {
    ...
    uint256 amountX = IERC20(USDC).balanceOf(address(this));
    ...
    //Approve Tokens
        IERC20(USDC).approve(0x013e138EF6008ae5FDFDE29700e3f2Bc61d21E3a, amountX);
...
ILBRouter(LBrouter).removeLiquidity( 
    IERC20(USDC), // Replace with actual token X address
