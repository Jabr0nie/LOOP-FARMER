...
address test = 0xeC0dedb726f86b71c43986ddBE71f70D6DAB13C7;
...
//Swap directly with MM
  ...
  function convertMoe() external payable {
        ...
        uint256 _amountIn = IERC20(Moe).balanceOf(address(this));
        uint256 amountIn = (_amountIn / 2);
  ...
  function convertMoeTo1BIN() external payable {
        ...
        uint256 amountIn = IERC20(0x4515A45337F461A11Ff0FE8aBF3c606AE5dC00c9).balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = 0x4515A45337F461A11Ff0FE8aBF3c606AE5dC00c9; //Moe token
        path[1] = 0x623b81Bd78E4442CdC3bEA7D4F97A87425563202; //1BIN token

        uint256 amountOutMin = 0;

        IERC20(0x4515A45337F461A11Ff0FE8aBF3c606AE5dC00c9).approve(router, amountIn);
  ...
  function convertUSDTTo1BIN() external payable {
        ...
        uint256 amountIn = IERC20(0x201EBa5CC46D216Ce6DC03F6a759e8E766e956aE).balanceOf(address(this));
        ...
        IERC20(0x201EBa5CC46D216Ce6DC03F6a759e8E766e956aE).approve(router, amountIn);
